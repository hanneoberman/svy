...
#legend(x = -1, legend = lvls, col = clrs, lty = 1, pch = 1)

#legend("left", c("Couple with children", "Single parent with children", "couple without children", "single without children"), col =c("steelblue1","plum2","sienna1","goldenrod1"), horiz = T )
