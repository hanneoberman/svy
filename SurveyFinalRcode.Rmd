...
society_3[society_3$a_gor_dv == "missing",]
society_3[society_3$a_gor_dv == "northern ireland",]
...
coeff <- with(society_3, lm(a_psnenip_xw ~ a_psnenip_xd + a_sex + a_dvage + NE + NW + Y + EM + WM + EOE + L + SE + SW + W))
