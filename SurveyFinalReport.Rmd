...
*Figure 2*. Histogram of design weight variable 'a_psnenip_xd'.
...
Sa??rndal, C.E. and Lunsdstrom, S. (2010). Design for Estimation: Identifying Auxiliary vectors to reduce nonresponse bias. Survey Methodology, 36, 131'144.
...
a. Investigate which age variable you should use (and whether choosing a particular age variable at all matters)

b. Construct a new variable 'household_composition' from the following four variables: 'a_livesp_dv, a_cohab_dv, a_single_dv, a_mastat_dv'. You may also use information from across household members to do this.
