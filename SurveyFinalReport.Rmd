...
**>>>>>>>>>>No variable about belief included in our dataset!**
...
$$\adjusted \weight \~ \design \weight + \sex + \age + \gor$$
...
These categories are theoretically logical: Children are gathered into one category (0-14), as are teens and young adults (15-24). Adults in the age range that is most likely to have young children are in one group (25-34), while older adults of working age are in another (35-)
